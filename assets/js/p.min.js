// task 4: Сохранить ответы юзера, по клику на кнопку “Ok” в
// последнем модальном окне(#p_modal3) вместо перехода на
// другую страницу, вывести ответы в консоль браузера.

let userAnswers = {};
function getTextComments() {
  const arrComments = document.querySelectorAll(".comment-content");
  for (let i = 0; i < arrComments.length; i++) {
    let someText = arrComments[i].childNodes[3].innerText;
    let textUsername = arrComments[i].childNodes[1].innerText;

    userAnswers[textUsername] = someText;
  }
  localStorage.setItem("userAnswers", JSON.stringify(userAnswers));
  let dataAnswers = localStorage.getItem("userAnswers");
